...
### RESTORE THE EXISTING JOKER MANAGER BACK TO NORMAL BEFORE UPGRADING IF HIDDEN!
...
Another major breakthrough in this release is that devices lower than Android 9.0 can now also use the advanced app hiding technique to hide the Magisk app. Due to this incompatible change, **RESTORE THE EXISTING JOKER MANAGER BACK TO NORMAL BEFORE UPGRADING IF HIDDEN!**
