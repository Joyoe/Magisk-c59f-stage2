...
void JoiskInit::mount_rules_dir(const char *dev_base, const char *mnt_base) {
    char path[128];
...
void JoiskInit::setup_tmp(const char *path) {
    ...
    close(fd);
    fd = xopen("joiskinit", O_WRONLY | O_CREAT, 0755);
    ...
    xsymlink("./joiskinit", "joiskpolicy");
    xsymlink("./joiskinit", "jojopolicy");
