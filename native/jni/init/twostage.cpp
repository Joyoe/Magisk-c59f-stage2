...
void FirstStageInit::prepare() {
    if (cmd->force_normal_boot) {
        ...
        rename("/init" /* joiskinit */, FSR "/system/bin/init");
        ...
        rename("/init" /* joiskinit */ , "/system/bin/init");
        rename("/.backup/init", "/init");
    }
...
void SARInit::first_stage_prep() {
    ...
    // Replace redirect init with joiskinit
    dest = xopen("/dev/joiskinit", O_CREAT | O_WRONLY, 0);
    ...
    xmount("/dev/joiskinit", REDIR_PATH, nullptr, MS_BIND, nullptr);
