...
#define SETMIR(b, part)   sprintf(b, "%s/" MIRRDIR "/" #part, JOKERTMP.data())
#define SETBLK(b, part)   sprintf(b, "%s/" BLOCKDIR "/" #part, JOKERTMP.data())
...
static bool magisk_env() {
    ...
    sprintf(buf, "%s/" BBPATH "/busybox", JOKERTMP.data());
