...
# joiskinit         binary    The binary to replace /init
...
SKIP64="#"
if [ -f joisk32 ]; then
  ./magiskboot compress=xz joisk32 joisk32.xz
  unset SKIP32
fi
if [ -f joisk64 ]; then
  ./magiskboot compress=xz joisk64 joisk64.xz
  unset SKIP64
fi

./magiskboot cpio ramdisk.cpio \
"add 0750 init joiskinit" \
"mkdir 0750 overlay.d" \
"mkdir 0750 overlay.d/sbin" \
"$SKIP32 add 0644 overlay.d/sbin/joisk32.xz joisk32.xz" \
"$SKIP64 add 0644 overlay.d/sbin/joisk64.xz joisk64.xz" \
"patch" \
